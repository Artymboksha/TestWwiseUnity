...
namespace Invector.vCharacterController
{
    public class vThirdPersonMotor : vCharacter
    {
        ...
        public virtual void StopCharacterWithLerp()
        {
            ...
            _rigidbody.linearVelocity = Vector3.Lerp(_rigidbody.linearVelocity, Vector3.zero, 4f * Time.deltaTime);
        ...
        protected virtual void RollBehavior()
        {
            ...
            if (rollUseGravity && baseLayerInfo.normalizedTime >= rollUseGravityTime) v.y = _rigidbody.linearVelocity.y;
        ...
        protected virtual void SlideMovementBehavior()
        {
            ...
            normal.y = 0f;
            var dir = Vector3.ProjectOnPlane(normal.normalized, groundHit.normal).normalized;
            _rigidbody.linearVelocity = dir * slideDownVelocity;
            dir.y = 0f;
