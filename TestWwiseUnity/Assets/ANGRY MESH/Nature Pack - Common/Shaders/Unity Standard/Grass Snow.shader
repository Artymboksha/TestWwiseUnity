...
Shader "ANGRYMESH/Nature Pack/Standard/Grass Snow"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandardCustom o )
		{
			...
			half TopMask211 = saturate( ( pow( abs( ( saturate( (WorldNormalVector( i , desaturateVar301 )).y ) + ( _TopOffset * AGG_SnowOffset ) ) ) , ( (1.0 + (_TopContrast - 0.0) * (200.0 - 1.0) / (1.0 - 0.0)) * AGG_SnowContrast ) ) * ( _TopIntensity * AGG_SnowIntensity ) ) );
...
/*ASEBEGIN
Version=17402
1927;29;1906;1004;-979.2644;1482.927;1;True;False
...
Node;AmplifyShaderEditor.RegisterLocalVarNode;211;-512,512;Half;False;TopMask;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.CommentaryNode;258;-1792,384;Inherit;False;1535.944;100;;0;// Top World Mapping;1,1,1,1;0;0
...
ASEEND*/
//CHKSM=52CD5E1B564133E225318F09CC4936A5833EFC05