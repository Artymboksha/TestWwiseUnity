...
Shader "ANGRYMESH/Nature Pack/Standard/Tree Leaf"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float mulTime10_g116 = _Time.y * temp_output_101_0_g116;
			...
			half temp_output_99_0_g115 = ( _WindLeafScale * AGW_WindScale );
			half temp_output_101_0_g115 = ( _WindLeafSpeed * AGW_WindSpeed );
			float mulTime10_g115 = _Time.y * temp_output_101_0_g115;
			half VColor_Blue1625 = v.color.b;
			half temp_output_73_0_g115 = ( AGW_WindToggle * ( VColor_Blue1625 * _WindLeafAmplitude ) * AGW_WindAmplitude );
			half Wind_HorizontalAnim1432 = temp_output_1428_0;
			half temp_output_48_0_g115 = Wind_HorizontalAnim1432;
			half temp_output_28_0_g115 = ( ( sin( ( ( ase_worldPos.z * temp_output_99_0_g115 ) + ( ( temp_output_101_0_g115 * _SinTime.z ) + mulTime10_g115 ) ) ) * temp_output_73_0_g115 ) * temp_output_48_0_g115 );
			half temp_output_49_0_g115 = VColor_Blue1625;
			half3 appendResult63_g115 = (half3(temp_output_28_0_g115 , ( ( sin( ( ( temp_output_99_0_g115 * ase_worldPos.y ) + mulTime10_g115 ) ) * temp_output_73_0_g115 ) * temp_output_49_0_g115 ) , temp_output_28_0_g115));
			...
			half2 appendResult8_g114 = (half2(ase_worldPos.x , ase_worldPos.z));
			half4 lerpResult17_g114 = lerp( _TintColor1 , _TintColor2 , saturate( ( tex2Dlod( AG_TintNoiseTexture, float4( ( appendResult8_g114 * ( 0.001 * AG_TintNoiseTile * _TintNoiseTile ) ), 0, 0.0) ).r * (0.001 + (AG_TintNoiseContrast - 0.001) * (60.0 - 0.001) / (10.0 - 0.001)) ) ));
			half4 lerpResult19_g114 = lerp( temp_cast_2 , lerpResult17_g114 , AG_TintToggle);
			o.vertexToFrag18_g114 = lerpResult19_g114;
		}
		...
		void surf( Input i , inout SurfaceOutputStandardCustom o )
		{
			...
			half3 break105_g118 = UnpackScaleNormal( tex2D( _BumpMap, uv_BumpMap1127 ), _BumpScale );
			...
			half4 TintColor1462 = i.vertexToFrag18_g114;
...
/*ASEBEGIN
Version=17402
1927;35;1906;998;7539.335;3214.502;5.883889;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;1484;-4608,736;Half;False;Property;_WindTrunkStiffness;Wind Trunk Stiffness;21;0;Create;True;0;0;False;0;3;2;1;3;0;1;FLOAT;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;1625;-4992,736;Half;False;VColor_Blue;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;1428;-4224,640;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1391;-3200,832;Half;False;Property;_WindLeafAmplitude;Wind Leaf Amplitude;22;0;Create;True;0;0;False;1;Header(Wind Leaf);1;1;0;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1442;-3200,1120;Half;False;Property;_WindLeafStiffness;Wind Leaf Stiffness;25;0;Create;True;0;0;False;0;0;1;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1485;-4608,832;Half;False;Property;_WindTrunkAmplitude;Wind Trunk Amplitude;20;0;Create;True;0;0;False;1;Header(Wind Trunk (use common settings for both materials));1;1;0;3;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1389;-3200,928;Half;False;Property;_WindLeafScale;Wind Leaf Scale;24;0;Create;True;0;0;False;0;15;15;0;30;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1390;-3200,1024;Half;False;Property;_WindLeafSpeed;Wind Leaf Speed;23;0;Create;True;0;0;False;0;2;2;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1459;-5248,-384;Half;False;Property;_TintNoiseTile;Tint Noise Tile;12;0;Create;True;0;0;False;0;10;10;0.001;30;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;1457;-5248,-768;Half;False;Property;_TintColor1;Tint Color 1;10;0;Create;True;0;0;False;1;Header(Tint Color);1,1,1,0;1,1,1,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;1458;-5248,-576;Half;False;Property;_TintColor2;Tint Color 2;11;0;Create;True;0;0;False;0;1,1,1,0;1,0,0,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;1655;-2560,640;Inherit;False;AG Global Wind - Tree;-1;;115;b3a3869a2b12ed246ae10bcce7d41e6e;0;6;48;FLOAT;0;False;49;FLOAT;0;False;96;FLOAT;1;False;94;FLOAT;1;False;95;FLOAT;1;False;97;FLOAT;1;False;1;FLOAT3;0
Node;AmplifyShaderEditor.FunctionNode;1660;-4864,-768;Inherit;False;AG Global Tint Color;0;;114;1dcc860732522ee469468f952b4e8aa1;0;3;27;COLOR;0,0,0,0;False;28;COLOR;0,0,0,0;False;22;FLOAT;0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;289;-2816,-1280;Half;False;Property;_BumpScale;Base Normal Intensity;5;0;Create;False;0;0;False;0;1;2;0;2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;1127;-2432,-1280;Inherit;True;Property;_BumpMap;Base NormalMap;8;2;[NoScaleOffset];[Normal];Create;False;0;0;False;0;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector3Node;1374;-1536,768;Half;False;Global;AGW_WindDirection;AGW_WindDirection;20;0;Create;True;0;0;False;0;0,0,0;0.9396927,-0.3420201,-1.098961E-07;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RegisterLocalVarNode;317;-2432,-1920;Half;False;Alpha_Albedo;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;332;-2432,-1792;Half;False;Property;_BackFaceColor;Back Face Color;9;0;Create;True;0;0;False;1;Header(Backface);1,1,1,0;1,1,1,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;1663;-2048,-1280;Inherit;False;AG Flip Normals;-1;;118;02ae90bb716acd647b8ac9db8603316a;0;1;110;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;216;-5248,-1280;Half;False;Property;_Glossiness;Base Smoothness;3;0;Create;False;0;0;False;1;Header(Base);0.5;0.5;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;1653;-2560,-768;Inherit;False;AG Global Transluncency;-1;;119;478210ebafb74104ba79a094e66bfe96;0;1;15;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.NormalizeNode;136;-1808,-1280;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;1115;0,-1504;Half;False;Property;_Cutoff;Alpha Cutoff;2;0;Create;False;0;0;True;0;0.5;0.3;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;640,-2176;Half;False;True;-1;2;;0;0;Standard;ANGRYMESH/Nature Pack/Standard/Tree Leaf;False;False;False;False;False;True;True;True;True;False;True;False;False;False;True;False;True;False;False;False;True;Off;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Masked;0.3;True;True;0;False;TransparentCutout;;AlphaTest;ForwardOnly;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;0;8.6;10;25;False;0.5;True;0;5;False;-1;10;False;-1;0;5;False;-1;10;False;-1;1;False;-1;1;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;13;-1;-1;0;False;0;0;False;-1;-1;0;True;1115;0;0;0;False;0.1;False;-1;0;False;-1;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=45EBF6E0F35C4C63FE777DEB3043B1E781AD6505